				...
				<tr>
					...
					<td>
						<form action="accountadmin/editaccount" method="post">
							<input type="hidden" name="currentUser.userId" value="${userId}" />
							<div class="form-group">
								<label>Email address</label> <input type="email"
									class="form-control" id="exampleInputEmail1"
									placeholder="test@example.com" name="currentUser.email"
									value="${email }" />
							</div>
							<div class="form-group">
								<label>Username</label> <input type="text" class="form-control"
									placeholder="Test" name="currentUser.name" value="${name}" />
							</div>
							<div class="form-group">
								<label>Password</label> <input type="password"
									class="form-control" placeholder="12345678"
									name="currentUser.password" value="${password}" />
							</div>
