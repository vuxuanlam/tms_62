			...
			<s:if test="listCourses">
				...
				<s:iterator value="listCourses">
					<tr>
						...
						<td>
							<div class="progress">
								<div class="progress-bar" role="progressbar" aria-valuenow="${progressOfCourse }"
									aria-valuemin="0" aria-valuemax="100" style="width: ${progressOfCourse }%">
									${progressOfCourse }%</div>
							</div>
